...
void Application::InitVariables(void)
{
	...
	m_pCameraMngr->SetPositionTargetAndUp(vector3(0.0f,0.0f,10.0f),vector3(0.0f,0.0f,0.0f),vector3(0.0f,1.0f,0.0f));

	//init the mesh
	m_pMesh = new MyMesh();
	//m_pMesh->GenerateCube(1.0f, C_WHITE);
	m_pMesh->GenerateCone(1.0f, 1.5f, 10, C_PURPLE);
}
...
void Application::Display(void)
{
	...
	vector3 v3Current = glm::lerp(v3Start, v3Stop1, fPercent);
		
		//(v3Start + v3End) * fPercent;
